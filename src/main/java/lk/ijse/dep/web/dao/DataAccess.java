...
public class DataAccess {
    ...
    public boolean deleteCustomer(String id) throws Exception {
        PreparedStatement pstm = connection.prepareStatement("DELETE FROM customer VALUES id=?");
        pstm.setString(1, id);
        return pstm.executeUpdate() > 0;
    }
    ...
    public boolean deleteItem(String code) throws Exception {
        PreparedStatement pstm = connection.prepareStatement("DELETE FROM item VALUES code=?");
